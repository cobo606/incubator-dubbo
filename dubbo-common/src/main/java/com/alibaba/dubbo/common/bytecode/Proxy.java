...
public abstract class Proxy {
     ...
     * Get proxy.
     *
     * <p> ccp 用于为服务接口生成代理类, 比如我们有一个 DemoService 接口, 这个接口代理类就是由 ccp 生成的.
     * ccm 则是用于为 org.apache.dubbo.common.bytecode.Proxy 抽象类生成子类, 主要是实现 Proxy 的抽象方法.
     *
        ...
        try {
            ...
            for (int i = 0; i < ics.length; i++) {
                ...
                for (Method method : ics[i].getMethods()) {
                    ...
                    // 如果已包含在 worked 中, 则忽略. 考虑这种情况, A 接口和 B 接口中包含一个完全相同的方法.
            ...
            // 构建接口代理类名称：pkg + ".proxy" + id, 比如 com.alibaba.dubbo.proxy0
...
/* 生成 org.apache.dubbo.demo.DemoService 这个接口代理类代码:
